...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="ps.html" class="w3-bar-item w3-button w3-padding-large w3-white">Problem Sets</a>
...
$psno = $_POST['psno'];
$name = "";
$sql = "SELECT fname from file where sid = '$sid' && psno = $psno";
...
if($name != "")
{
echo '<a class="downadi" target="_blank" href="uploads/'.$name.'">DOWNLOAD PS</a>';
}
