...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="ut.html" class="w3-bar-item w3-button w3-padding-large w3-white">Institute Tests</a>
...
$utno = $_POST['utno'];
$name = "";
$sql = "SELECT fname from file where sid = '$sid' && utno = $utno";
...
if($name != "")
{
echo '<a class="downadi" target="_blank" href="uploads/'.$name.'">DOWNLOAD IT PAPER</a>';
}
